...
//
//            //readGranted = true // TODO dont do this
//
//        } else {
//
//            Log.d(TAG, "Oncreate: requesting permission")
                ...
                Snackbar.make(view,"Please grant access to your contacts", Snackbar.LENGTH_INDEFINITE)
                    .setAction("Grant Access", {
                        ...
                        if (ActivityCompat.shouldShowRequestPermissionRationale(this, READ_CONTACTS)) {
                            ...
                            //The user has permently denied the permission, take them direct to the settings
...
//
//                    // permission was granted, Yay do the contacts-related tasks we need to do.
